...
func (s SendMessage) Params() (Params, error) {
	...
	err = params.AddInterface("link_preview_options ", s.LinkPreviewOptions)
	if err != nil {
		return params, err
	}
	params.AddBool("disable_notification", s.DisableNotification)
	params.AddBool("protect_content", s.ProtectContent)
	err = params.AddInterface("reply_parameters", s.ReplyParameters)
	if err != nil {
		return params, err
	}
...
// ForwardMessages Forward multiple messages of any kind. If some of the specified messages can't be found or forwarded, they are skipped. Service messages and messages with protected content can't be forwarded. Album grouping is kept for forwarded messages. On success, an array of MessageId of the sent messages is returned.
...
func (s ForwardMessages) Params() (Params, error) {
	...
	err = params.AddInterface("message_ids", s.MessageIds)
	if err != nil {
		return params, err
	}
	params.AddBool("disable_notification", s.DisableNotification)
...
// SetMessageReaction Change the chosen reactions on a message. Service messages can't be reacted to. Automatically forwarded messages from a channel to its discussion group have the same available reactions as messages in the channel. In albums, bots must react to the first message. Returns True on success.
...
func (s SetMessageReaction) Params() (Params, error) {
	...
	params["message_id"] = strconv.Itoa(s.MessageID)
	err = params.AddInterface("reaction", s.Reaction)
	if err != nil {
		return params, err
	}
...
// GetForumTopicIconStickers Get custom emoji stickers, which can be used as a forum topic icon by any user. Requires no parameters. Returns an Array of Sticker objects.
...
// CreateForumTopic Create a topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights. Returns information about the created topic as a ForumTopic object.
...
// EditForumTopic Edit name and icon of a topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have can_manage_topics administrator rights, unless it is the creator of the topic. Returns True on success.
...
func (s EditForumTopic) Params() (Params, error) {
	...
	params["message_thread_id"] = strconv.Itoa(s.MessageThreadId)
	params.AddNonEmpty("name", s.Name)
	params.AddNonEmpty("icon_custom_emoji_id", s.IconCustomEmojiId)
...
// CloseForumTopic Close an open topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights, unless it is the creator of the topic. Returns True on success.
...
// ReopenForumTopic Reopen a closed topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights, unless it is the creator of the topic. Returns True on success.
...
// DeleteForumTopic Delete a forum topic along with all its messages in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_delete_messages administrator rights. Returns True on success.
...
// UnpinAllForumTopicMessages Clear the list of pinned messages in a forum topic. The bot must be an administrator in the chat for this to work and must have the can_pin_messages administrator right in the supergroup. Returns True on success.
...
// EditGeneralForumTopic Edit the name of the 'General' topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have can_manage_topics administrator rights. Returns True on success.
...
// CloseGeneralForumTopic Close an open 'General' topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights. Returns True on success.
...
// ReopenGeneralForumTopic Reopen a closed 'General' topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights. The topic will be automatically unhidden if it was hidden. Returns True on success.
...
// HideGeneralForumTopic Hide the 'General' topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights. The topic will be automatically closed if it was open. Returns True on success.
...
// UnHideGeneralForumTopic UnHide the 'General' topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights. Returns True on success.
...
// UnpinAllGeneralForumTopicMessages Clear the list of pinned messages in a General forum topic. The bot must be an administrator in the chat for this to work and must have the can_pin_messages administrator right in the supergroup. Returns True on success.
...
func (s CreateNewStickerSet) Params() (Params, error) {
	...
	params["name"] = s.Name
	params["title"] = s.Title
	err := params.AddInterface("stickers", s.Stickers)
	if err != nil {
		return params, err
	}
	params["sticker_format"] = s.StickerFormat
...
func (s AddStickerToSet) Params() (Params, error) {
	...
	params["user_id"] = strconv.FormatInt(s.UserID, 10)
	params["name"] = s.Name
	err := params.AddInterface("sticker", s.Sticker)
...
// SetCustomEmojiStickerSetThumb Set the thumbnail of a custom emoji sticker set. Returns True on success.
type SetCustomEmojiStickerSetThumb struct {
	Name          string // required
	CustomEmojiID string
}

func (s SetCustomEmojiStickerSetThumb) Params() (Params, error) {
	params := make(Params, 2)
...
func (s SetCustomEmojiStickerSetThumb) EndPoint() string {
	return config.EndpointSetCustomEmojiStickerSetThumb
}
