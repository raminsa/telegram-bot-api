...
func (t *Api) GetChatAdministrators(c types.GetChatAdministrators) ([]interface{}, error) {
	if c.ChatID == 0 && c.ChatIDStr == "" && c.Username == "" {
		return nil, errors.New("ChatID or Username Required")
	}
...
func (t *Api) GetChatMember(c types.GetChatMember) (interface{}, error) {
	if c.ChatID == 0 && c.ChatIDStr == "" && c.Username == "" {
		return nil, errors.New("ChatID or Username Required")
	}
	if c.UserID == 0 {
...
func (t *Api) GetForumTopicIconStickers(c types.GetForumTopicIconStickers) (*types.Sticker, error) {
	...
	err = json.Unmarshal(resp.Result, &sticker)
...
func (t *Api) CreateForumTopic(c types.CreateForumTopic) (*types.ForumTopic, error) {
	...
	var formTopic types.ForumTopic
	err = json.Unmarshal(resp.Result, &formTopic)

	return &formTopic, err
}
...
func (t *Api) EditForumTopic(c types.EditForumTopic) (bool, error) {
	...
	if c.MessageThreadId == 0 {
		return false, errors.New("MessageThreadId Required")
	}
...
func (t *Api) GetMyName(c types.GetMyName) (*types.BotName, error) {
	...
	var botName types.BotName
	err = json.Unmarshal(resp.Result, &botName)
...
func (t *Api) GetMyDescription(c types.GetMyDescription) (*types.GetMyDescription, error) {
	resp, err := t.Request(c)
	if err != nil {
		return nil, err
	}

	var botDescription types.GetMyDescription
	err = json.Unmarshal(resp.Result, &botDescription)
...
func (t *Api) GetMyShortDescription(c types.GetMyShortDescription) (*types.BotShortDescription, error) {
	...
	var botShortDescription types.BotShortDescription
	err = json.Unmarshal(resp.Result, &botShortDescription)
...
func (t *Api) GetChatMenuButton(c types.GetChatMenuButton) (*types.MenuButton, error) {
	if c.ChatID == 0 && c.ChatIDStr == "" && c.Username == "" {
		return nil, errors.New("ChatID or Username Required")
	}
	...
	var menuButton types.MenuButton
...
// SetCustomEmojiStickerSetThumb Use this method to set the thumbnail of a custom emoji sticker set. Returns True on success.
func (t *Api) SetCustomEmojiStickerSetThumb(c types.SetCustomEmojiStickerSetThumb) (bool, error) {
	if c.Name == "" {
		return false, errors.New("Name Required")
	}
